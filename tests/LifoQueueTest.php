...
use Nia\Collection\Queue\LifoQueue;

/**
 * Unit test for \Nia\Collection\Queue\LifoQueue.
 */
class LifoQueueTest extends PHPUnit_Framework_TestCase
{

    /**
     * @covers \Nia\Collection\Queue\LifoQueue
     */
